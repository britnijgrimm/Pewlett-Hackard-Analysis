...
--Export retirement eligibility to new table
SELECT first_name, last_name
...
--Joining retirement_info and dept_emo tables, create current_emp table
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
--Tailored List of sales retirees
SELECT * FROM retirement_info
...
--Tailored list of sales and development retirees
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	d.dept_name
